<?php
/**
 * Custom gamiphy html widget
 * @package Gamiphy
 */

class gamiphy_html_widget extends WP_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct( 'gamiphy_html_widget', __( 'Gamiphy Custom HTML' ), $widget_ops, $control_ops );
    }
...
// register  widget
add_action('widgets_init', create_function('', 'return register_widget("gamiphy_html_widget");'));